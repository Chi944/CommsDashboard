...
export const commodities = [
  ...
  { ticker: 'AMZN',  symbol: 'AMZN',   name: 'Amazon',       category: 'TECH',        unit: '$',       price: 185,   high: 188,   low: 182,   changePct: 0, changeAbs: 0, history: buildHistory(180, 2.5, 235) },
  ...
  { ticker: 'AVGO',  symbol: 'AVGO',   name: 'Broadcom',     category: 'TECH',        unit: '$',       price: 1450,  high: 1480,  low: 1420,  changePct: 0, changeAbs: 0, history: buildHistory(1420, 22, 241) },
  { ticker: 'AMD',   symbol: 'AMD',    name: 'AMD',          category: 'TECH',        unit: '$',       price: 165,   high: 170,   low: 160,   changePct: 0, changeAbs: 0, history: buildHistory(160, 3.5, 251) },
  { ticker: 'NFLX',  symbol: 'NFLX',   name: 'Netflix',      category: 'TECH',        unit: '$',       price: 620,   high: 628,   low: 612,   changePct: 0, changeAbs: 0, history: buildHistory(610, 8, 257) },
  { ticker: 'TSM',   symbol: 'TSM',    name: 'TSMC',         category: 'TECH',        unit: '$',       price: 155,   high: 158,   low: 152,   changePct: 0, changeAbs: 0, history: buildHistory(152, 2.4, 263) },
  ...
  { ticker: 'AI',    symbol: 'AI',     name: 'C3.ai',        category: 'DATA',        unit: '$',       price: 22,    high: 23,    low: 21,    changePct: 0, changeAbs: 0, history: buildHistory(21, 0.5, 269) },
  { ticker: 'SMCI',  symbol: 'SMCI',   name: 'Super Micro',  category: 'DATA',        unit: '$',       price: 720,   high: 740,   low: 700,   changePct: 0, changeAbs: 0, history: buildHistory(700, 18, 277) },
  { ticker: 'ARM',   symbol: 'ARM',    name: 'Arm Holdings', category: 'DATA',        unit: '$',       price: 110,   high: 115,   low: 108,   changePct: 0, changeAbs: 0, history: buildHistory(108, 2.5, 281) },
  { ticker: 'COIN',  symbol: 'COIN',   name: 'Coinbase',     category: 'DATA',        unit: '$',       price: 220,   high: 225,   low: 215,   changePct: 0, changeAbs: 0, history: buildHistory(215, 6, 283) },
  ...
  { ticker: 'BNB',   symbol: 'BNB',    name: 'BNB',          category: 'CRYPTO',      unit: '$',       price: 580,   high: 590,   low: 570,   changePct: 0, changeAbs: 0, history: buildHistory(570, 10, 293) },
  { ticker: 'XRP',   symbol: 'XRP',    name: 'Ripple',       category: 'CRYPTO',      unit: '$',       price: 0.52,  high: 0.54,  low: 0.50,  changePct: 0, changeAbs: 0, history: buildHistory(0.51, 0.012, 307) },
  ...
  { ticker: 'ADA',   symbol: 'ADA',    name: 'Cardano',      category: 'CRYPTO',      unit: '$',       price: 0.46,  high: 0.48,  low: 0.44,  changePct: 0, changeAbs: 0, history: buildHistory(0.45, 0.012, 311) },
  { ticker: 'AVAX',  symbol: 'AVAX',   name: 'Avalanche',    category: 'CRYPTO',      unit: '$',       price: 35,    high: 36,    low: 34,    changePct: 0, changeAbs: 0, history: buildHistory(34, 1.0, 313) },
  { ticker: 'DOT',   symbol: 'DOT',    name: 'Polkadot',     category: 'CRYPTO',      unit: '$',       price: 6.8,   high: 7.0,   low: 6.6,   changePct: 0, changeAbs: 0, history: buildHistory(6.7, 0.18, 317) },
  { ticker: 'LINK',  symbol: 'LINK',   name: 'Chainlink',    category: 'CRYPTO',      unit: '$',       price: 14.5,  high: 15,    low: 14,    changePct: 0, changeAbs: 0, history: buildHistory(14, 0.4, 331) },
