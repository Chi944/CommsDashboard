...
/**
 * EIA v2 routes — latest 2 daily observations, published on a weekly cadence.
...
/** Tickers that receive v2 API overlay (not Yahoo). Oil futures remain Yahoo-authoritative. */
export const V2_COMMODITY_TICKERS = new Set(EIA_TICKERS);
