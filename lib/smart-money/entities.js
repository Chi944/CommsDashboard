...
const ENTITY_REGISTRY = Object.freeze([
  {
    ...
    strategyTags: ['AI', 'macro'], people: ['Leopold Aschenbrenner'], relatedEntityIds: ['situational-awareness-lp'], officialUrls: ['https://situational-awareness.ai/', 'https://www.forourposterity.com/'],
...
const ADAPTER_CONFIGS = Object.freeze([
  ...
  { id: 'institutional-strategy', rightsId: 'strategy-disclosures', requiredPurposes: ENABLED_PURPOSES },
  { id: 'institutional-tesla', rightsId: 'tesla-disclosures', requiredPurposes: ENABLED_PURPOSES },
  { id: 'institutional-ibit', rightsId: 'ibit-disclosures', requiredPurposes: ENABLED_PURPOSES },
  { id: 'institutional-fbtc', rightsId: 'fbtc-disclosures', requiredPurposes: ENABLED_PURPOSES },
  { id: 'institutional-arkb', rightsId: 'arkb-disclosures', requiredPurposes: ENABLED_PURPOSES },
  { id: 'institutional-bitb', rightsId: 'bitb-disclosures', requiredPurposes: ENABLED_PURPOSES },
]);
