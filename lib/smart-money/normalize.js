...
import { validateSimulationCapability } from './capability.js';
...
const SNAPSHOT_FIELDS = Object.freeze([
  ...
  'signals', 'rankings', 'providerStatuses', 'warnings', 'sourceLinks', 'simulationCapability',
]);
...
export function validateAcceptedSnapshot(value, context = {}) {
  ...
  return {
    ...
    sourceLinks,
    simulationCapability: validateSimulationCapability(value.simulationCapability),
  };
}
